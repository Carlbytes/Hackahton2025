...
![License](https://img.shields.io/github/license/Carlbytes/Hackahton2025?style=for-the-badge)

> **"Experience the cosmos up close with real-time NASA data."**
...
![VR](https://img.shields.io/badge/XR-OpenXR%20%2F%20Oculus-ff0000?style=for-the-badge&logo=oculus&logoColor=white)
![NASA](https://img.shields.io/badge/Data-NASA_API-0B3D91?style=for-the-badge&logo=nasa&logoColor=white)
...
* **Moon Textures**: [NASA SVS #4720](https://svs.gsfc.nasa.gov/4720)
* **Asteroid Textures**: [NASA SVS #5069](https://svs.gsfc.nasa.gov/5069)
...
* **VR Headset** (Meta Quest 2/3 recommended) configured with Oculus Link or Air Link.

### Installation

1.  Clone the repository:
    ```bash
    git clone [https://github.com/Carlbytes/Hackahton2025.git](https://github.com/Carlbytes/Hackahton2025.git)
    ```
2.  Open **Unity Hub**.
